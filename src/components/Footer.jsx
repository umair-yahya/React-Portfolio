			...
			<div className="container">
				<div className="sm:flex items-center justify-between md:gap-8">
					<div className="w-full sm:w-1/2">
						<h2
							className="text-[26px] leading-10 text-white font-[600] mb-5
            md:text-[2rem]"
						>
						...
						return (
							<div className="w-full sm:w-1/2">
								<p className="text-gray-300 leading-7 mt-4 sm:mt-0">
									If you're looking for stunning and imaginative websites,
									you've come to the right place! I specialize in crafting
									beautiful and creative designs. Whether it's for your business
									or personal project, I'd love to work with you. Get in touch
			...
			<div className="bg-[#1b1e29] py-3 mt-14">
				<div className="container">
                    ...
                    text-white font-[500] text-[18px] flex items-center justify-center"
						...
						<div>
							<p className="text-gray-400 txt-[14px]">
								Copyright {year} developed by Umair - All rights reserved.
							</p>
						</div>
					</div>
				</div>
